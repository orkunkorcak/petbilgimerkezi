  ...
  return (
    <>
      <div className={css.container}>
        ...
        <h2 className={css.h2}>Sağlık Raporu</h2>
        <p>
          Hava yolu firmaları, hem hastalık riski hem de basınç değişimleri
          nedeniyle sevimli dostunuzun uçuşa uygun olduğunu belgelemenizi ister.
          Bu nedenle bir veteriner kliniğine giderek seyahat için sağlık raporu
          almanız gerekmektedir. Sağlık raporu yerine ev hayvanı pasaportunuzun arka kısmında yer
          alan “klinik muayene” bölümünü imzalatabilirsiniz; ancak bu kısmı
          yalnızca devlet veteriner hekimleri imzalayabilir. İlgili onayı il
          veya ilçe tarım müdürlüklerinden alabilirsiniz.
        </p>
        ...
        <p>
          ...
          <span className={css.span}>
            Türk Hava Yolları için kafes ebatları:
          </span>{" "}
          23 cm yükseklik, 30 cm genişlik ve 40 cm uzunluk boyutlarını
          aşmamalıdır.Bagaj bölümünde taşınan evcil hayvanların kafes ebatları:
          75 cm yükseklik, 75 cm genişlik ve 125 cm uzunluk boyutlarını
          aşmamalıdır. Ağırlığı ise kafesiyle birlikte 50 kg’ı geçmemelidir.
          <br />
          <span className={css.span}>Pegasus hava yolları</span> için kafes
          boyutu en fazla 32x32x50 ölçülerinde olabilir.
          <br />
          <span className={css.span}>AJet hava yolları</span> için kafes boyutu
          en fazla 23x30x40 ölçülerinde olabilir.
        </p>
        <h2 className={css.h2}>Hangi Çanta Kullanılmalı</h2>
        <p>
          <span className={css.span}>Kabin İçi Yolculuk İçin:</span> Kumaş ya da
          delikli plastikten yapılmış, yüksek hava geçirgenliğine sahip çantalar
          tercih edilmelidir. Naylon oranı yüksek, hava sirkülasyonu yetersiz
          çantalar sera etkisi yaratabilir. Bu da evcil hayvanınızın çanta
          içinde hararet yapmasına ve bunalarak rahatsız olmasına yol açabilir.
          <br />
          <br />
          <span className={css.span}>Kargo Bölümü İçin:</span> Kargo bölümünde
          seyahat edecek hayvanlar için: Sert malzemeli, Darbeye dayanıklı,
          Geniş hacimli ve Bol hava delikli çantalar tercih edilmelidir. Her ne
          kadar hava yolu personelleri evcil dostunuzun güvenliğini sağlamak
          için özen gösterse de, uçuş sırasında bagajların yer değiştirmesi,
          çarpması gibi durumlar yaşanabilir. Bu yüzden çantanızın darbelere
          karşı koruyucu özellikte olması büyük önem taşır.
        </p>
